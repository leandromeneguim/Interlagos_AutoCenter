...
const PROMOTIONS = [
  {
    ...
    image: "https://example.com/amortecedor.jpg",
    stars: 5
  },
  {
    ...
    price: "6.66",
    originalPrice: "39.99",
    image: "https://example.com/pastilha.jpg",
    stars: 5
  },
  {
    ...
    price: "21.65",
    originalPrice: "52.90",
    image: "https://example.com/correia.jpg",
    stars: 5
  },
  {
    title: "EMBREAGEM",
    ...
    image: "https://example.com/embreagem.jpg",
    stars: 5
  }
];
    ...
    <section className="py-12 px-4">
      <div className="container mx-auto">
        <div className="flex justify-center mb-8">
          <h2 className="text-2xl font-bold text-red-600">POUCAS UNIDADES!!!</h2>
        </div>
